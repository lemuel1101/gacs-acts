<div>
    <x-dialog-modal wire:model.live="add" :maxWidth="'xl'" wire:key="addcharts-modal">
        <x-slot name="title">
            {{ __('Adding Accounts') }}
        </x-slot>
        <x-slot name="content">
            ...
            <div class="w-full bg-transparent rounded mx-auto px-5 pt-6 mb-4 flex flex-col my-2">
                ...
                <div class="flex flex-wrap -mx-3 mb-0">
                    <div class="w-full px-3 mb-3">
                        ...
                        <x-input-error for="code" class="mb-4" />
                    </div>
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-3">
                        ...
                        <x-input-error for="nb" class="mb-4" />
                    </div>
                    <div class="w-full md:w-1/2 px-3 mb-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                            for="grid">
                        ...
                        <x-input-error for="type" class="mb-4" />
                    </div>
        ...
        <x-slot name="footer">
            <x-secondary-button class="ml-3" wire:click="saving" wire:loading.attr="disabled"
