<x-app-layout>
    ...
    <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
            <div
                class="bg-green-800 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-8 border-blue-600  dark:border-gray-600 text-white font-medium group ">
                <div
                ...
                <div class="text-right">
                    <p class="text-2xl text-white">to be edited</p>
                    <p>to edited</p>
                </div>
            </div>
            {{-- <div
